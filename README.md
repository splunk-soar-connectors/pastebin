...
This table lists the configuration variables required to operate PasteBin. These variables are specified when configuring a PasteBin asset in Splunk SOAR.
